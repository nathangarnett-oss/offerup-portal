...
const jobData: { title: string; companyName: string; jobType: JobType; jobCategory: JobCategory; payType: PayType; payMin: number; payMax: number; location: string; remote: boolean; description: string; requirements: string; benefits: string[]; schedule: string; applicationCount: number; status: 'active' | 'closed' | 'draft'; promoted: boolean; promotionDays?: number }[] = [
  {
    ...
    location: 'Seattle, WA',
    remote: false,
    description: 'We\'re looking for an enthusiastic Barista to join our in-store coffee shop! You\'ll craft specialty espresso drinks, serve customers with a smile, and help create a welcoming atmosphere in our electronics retail space.\n\nResponsibilities:\n- Prepare espresso-based beverages and brewed coffee to standard recipes\n- Greet customers warmly and take orders accurately\n- Maintain a clean and organized coffee bar area\n- Restock supplies and ingredients throughout your shift\n- Handle cash and card transactions using our POS system\n- Assist with opening and closing procedures',
    requirements: 'Customer service experience preferred. Must be available weekends. Food handler\'s permit required within 30 days of hire. Ability to stand for extended periods.',
    benefits: ['Employee discount on electronics', 'Free drinks during shifts', 'Flexible scheduling', 'Tips on top of hourly pay'],
    schedule: 'Part-time, 20-30 hours/week. Shifts available: mornings (7am-1pm) and afternoons (1pm-7pm). Weekend availability required.',
    applicationCount: 23,
    status: 'active',
    promoted: true,
    promotionDays: 7,
  },
  {
    ...
    remote: false,
    description: 'Join our growing fulfillment team! As a Warehouse Associate, you\'ll play a key role in getting electronics orders picked, packed, and shipped to customers across the Pacific Northwest.\n\nResponsibilities:\n- Pick and pack customer orders accurately and efficiently\n- Receive and process incoming inventory shipments\n- Operate pallet jacks and warehouse equipment safely\n- Maintain inventory accuracy through cycle counts\n- Keep the warehouse clean, organized, and safe\n- Meet daily productivity targets while maintaining quality standards',
    requirements: 'Able to lift 50 lbs repeatedly. Must be comfortable standing and walking for 8+ hour shifts. Forklift certification a plus but not required — we\'ll train you. Basic computer skills for inventory system. Must pass background check.',
    benefits: ['Health insurance (medical, dental, vision)', 'Paid time off', '401(k) with company match', 'Employee discount', 'Steel-toe boot reimbursement', 'Overtime opportunities'],
    schedule: 'Full-time, Monday-Friday, 7:00 AM - 3:30 PM. Occasional overtime during peak seasons.',
    applicationCount: 41,
    status: 'active',
    promoted: true,
    promotionDays: 5,
  },
  {
    ...
    location: 'Seattle, WA',
    remote: true,
    description: 'We\'re building the next generation of our e-commerce platform and need a talented Frontend Developer to help us get there. You\'ll work closely with our product and design teams to create fast, accessible, and beautiful user experiences.\n\nResponsibilities:\n- Build and maintain responsive web interfaces using React and Next.js\n- Write clean, well-tested TypeScript code\n- Collaborate with UX designers to implement pixel-perfect designs\n- Optimize web performance and Core Web Vitals\n- Participate in code reviews and contribute to engineering best practices\n- Help shape our frontend architecture and tooling decisions',
    requirements: '3+ years of professional frontend development experience. Strong proficiency with React and TypeScript. Experience with Next.js or similar SSR frameworks. Familiarity with REST APIs and state management patterns. Understanding of web accessibility (WCAG). Git version control. Bonus: experience with Tailwind CSS, testing libraries (Jest, Playwright).',
    benefits: ['Competitive salary + equity', 'Fully remote — work from anywhere', 'Health, dental, and vision insurance', 'Unlimited PTO', '$1,500 annual learning budget', 'Home office stipend', '401(k) with 4% match'],
    schedule: 'Full-time, flexible hours. Core collaboration hours 10am-3pm PT.',
    applicationCount: 67,
    status: 'active',
    promoted: false,
  },
  {
    ...
    location: 'Seattle, WA',
    remote: false,
    description: 'Deliver electronics directly to customers\' doors in the greater Seattle area. We offer same-day delivery for our marketplace buyers, and you\'ll be the face of our brand.\n\nResponsibilities:\n- Pick up packaged orders from our Seattle warehouse\n- Deliver items safely to customers within scheduled windows\n- Verify deliveries with photo confirmation\n- Communicate with customers about delivery timing\n- Handle returns and exchanges as needed\n- Maintain delivery logs and mileage records',
    requirements: 'Valid Washington state driver\'s license. Clean driving record (no major violations in last 3 years). Reliable vehicle in good condition (or use our company van). Smartphone with GPS capability. Must be able to lift up to 70 lbs. Proof of auto insurance required.',
    benefits: ['Mileage reimbursement ($0.67/mile)', 'Flexible scheduling — pick your shifts', 'Weekly pay via direct deposit', 'Performance bonuses for on-time delivery'],
    schedule: 'Gig / flexible. Delivery windows available 7 days a week, 8am-8pm. Choose shifts that work for you.',
    applicationCount: 18,
    status: 'active',
    promoted: false,
  },
  {
    ...
    remote: false,
    description: 'Love tech? So do we. We\'re looking for a friendly and knowledgeable Sales Associate to help customers find the perfect electronics at our San Francisco location.\n\nResponsibilities:\n- Greet and assist customers on the sales floor\n- Provide expert product recommendations based on customer needs\n- Demonstrate electronics features and answer technical questions\n- Process sales transactions and handle returns\n- Maintain attractive product displays and store appearance\n- Stay up to date on new products and promotions',
    requirements: 'Electronics knowledge helpful but we\'ll train the right person. Retail or customer service experience preferred. Strong communication and interpersonal skills. Must be available at least 3 days/week including one weekend day. Comfortable with point-of-sale systems.',
    benefits: ['Generous employee discount (40% off)', 'Commission on high-value sales', 'Flexible scheduling', 'Career growth opportunities'],
    schedule: 'Part-time, 15-25 hours/week. Store hours: Mon-Sat 10am-8pm, Sun 11am-6pm.',
    applicationCount: 12,
    status: 'active',
    promoted: false,
  },
  {
    ...
    location: 'Seattle, WA',
    remote: false,
    description: 'Keep our business running smoothly! We need a detail-oriented Office Administrator to manage day-to-day operations at our Seattle headquarters.\n\nResponsibilities:\n- Manage calendars, schedule meetings, and coordinate travel\n- Handle vendor communications and purchase orders\n- Process invoices and assist with basic bookkeeping\n- Maintain office supplies and equipment\n- Organize company events and team lunches\n- Support HR with onboarding new employees\n- Manage incoming mail, packages, and phone inquiries',
    requirements: 'Proficient in Google Workspace (Docs, Sheets, Calendar, Gmail). 2+ years of administrative or office management experience. Excellent written and verbal communication. Strong organizational skills and attention to detail. Experience with QuickBooks or similar accounting software is a plus.',
    benefits: ['Health insurance (medical, dental, vision)', 'Paid time off (15 days + holidays)', '401(k) with company match', 'Free parking', 'Snacks and coffee provided'],
  ...
  },
  {
    ...
    location: 'Seattle, WA',
    remote: true,
    description: 'Gain hands-on experience in digital marketing for a growing e-commerce business! This summer internship will give you real responsibility and mentorship from our marketing team.\n\nResponsibilities:\n- Create and schedule social media content across platforms\n- Assist with email marketing campaigns and A/B testing\n- Help optimize our OfferUp marketplace listings for better visibility\n- Analyze marketing performance data and create reports\n- Research competitor strategies and market trends\n- Contribute creative ideas to our marketing roadmap',
    requirements: 'Currently enrolled in a college/university program. Marketing, business, or communications major preferred. Familiarity with social media platforms (Instagram, TikTok, X). Basic understanding of digital marketing concepts. Strong writing skills. Interest in e-commerce or tech. Portfolio or examples of creative work is a bonus.',
    benefits: ['Paid internship ($18-22/hr)', 'Fully remote with flexible hours', 'Mentorship from senior marketing team', 'Potential for full-time offer', 'Company laptop provided'],
    schedule: 'Summer 2026 (June-August). 20-40 hours/week, flexible schedule. Remote with optional in-office days.',
    applicationCount: 8,
    status: 'draft',
    promoted: false,
  },
  {
    ...
    location: 'Portland, OR',
    remote: false,
    description: 'We\'re looking for a skilled Electronics Repair Technician to diagnose and fix consumer electronics at our Portland repair center. This is a 6-month contract with possibility of extension.\n\nResponsibilities:\n- Diagnose hardware and software issues in smartphones, laptops, tablets, and gaming consoles\n- Perform component-level repairs including micro-soldering\n- Replace screens, batteries, charging ports, and other components\n- Document repairs and maintain accurate service records\n- Communicate repair timelines and costs to customers\n- Maintain a clean and organized workstation',
    requirements: 'Proven experience repairing consumer electronics. Micro-soldering skills required. Familiarity with diagnostic tools and multimeters. CompTIA A+ certification preferred. Experience with Apple and Samsung device repair is a strong plus. Must have own repair toolkit.',
    benefits: ['Competitive hourly rate ($25-40/hr)', 'Tools and parts provided', 'Flexible scheduling', 'Contract-to-hire opportunity'],
    schedule: 'Contract, 6 months. Monday-Friday, flexible start time between 8am-10am. ~40 hours/week.',
    applicationCount: 15,
    status: 'closed',
    promoted: false,
  },
